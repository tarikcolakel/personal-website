    ...
    <main className="flex flex-col md:flex-row items-center justify-between gap-8 p-6 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      <div className="text-container flex flex-col items-start md:w-1/2 space-y-4">
        ...
        <div className="freelance-container flex items-center gap-4">
          <a href="https://www.linkedin.com/in/ahmet-%C3%A7olakel-3b99211b7/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:scale-110 transition">
            <Linkedin className="w-6 h-6" />
          </a>
          <a href="https://github.com/tarikcolakel" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-gray-200 hover:scale-110 transition">
